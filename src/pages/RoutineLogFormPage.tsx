...
export function RoutineLogFormPage() {
  ...
  const load = useCallback(async () => {
    ...
    await checkPending()
    setLoaded(true)
  }, [id, isEdit, fromId, fromTemplateId, defaultDate, checkPending])
  ...
  return (
    <div className="detail">
      ...
      <ConfirmDialog
        ...
        message={
          draft.pending
            ? `${formatDotDate(draft.pending.form.date)} · 운동 ${draft.pending.form.exercises.length}개`
            : undefined
        }
        confirmLabel="이어쓰기"
        cancelLabel="새로 시작"
